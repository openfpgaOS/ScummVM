...
#ifdef NONSTANDARD_PORT
void *BaseCostumeRenderer::operator new(size_t size) {
	return openfpga_pool_alloc(kOpenFPGAPoolCostumeRenderer, size);
}

void BaseCostumeRenderer::operator delete(void *p) noexcept {
	openfpga_pool_free(kOpenFPGAPoolCostumeRenderer, p);
}

void BaseCostumeRenderer::operator delete(void *p, size_t) noexcept {
	BaseCostumeRenderer::operator delete(p);
}

void *BaseCostumeLoader::operator new(size_t size) {
	return openfpga_pool_alloc(kOpenFPGAPoolCostumeLoader, size);
}

void BaseCostumeLoader::operator delete(void *p) noexcept {
	openfpga_pool_free(kOpenFPGAPoolCostumeLoader, p);
}

void BaseCostumeLoader::operator delete(void *p, size_t) noexcept {
	BaseCostumeLoader::operator delete(p);
}
#endif
