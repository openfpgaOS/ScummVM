...
void *Actor::operator new(size_t size) {
	return openfpga_pool_alloc(kOpenFPGAPoolScummActor, size);
}

void Actor::operator delete(void *p) noexcept {
	openfpga_pool_free(kOpenFPGAPoolScummActor, p);
}

void Actor::operator delete(void *p, size_t) noexcept {
	Actor::operator delete(p);
}
#endif
